...
-- --------------------------------------------------
-- Date Created: 03/25/2020 21:53:27
...
-- Creating primary key on [Actividad_Id], [Participante_Id] in table 'ActividadParticipante'
ALTER TABLE [dbo].[ActividadParticipante]
ADD CONSTRAINT [PK_ActividadParticipante]
    PRIMARY KEY CLUSTERED ([Actividad_Id], [Participante_Id] ASC);
GO

-- Creating primary key on [Actividad_Id], [ActividadAsistente_Actividad_Id] in table 'ActividadAsistente'
ALTER TABLE [dbo].[ActividadAsistente]
ADD CONSTRAINT [PK_ActividadAsistente]
    PRIMARY KEY CLUSTERED ([Actividad_Id], [ActividadAsistente_Actividad_Id] ASC);
GO
...
-- Creating foreign key on [Actividad_Id] in table 'ArticuloSet'
ALTER TABLE [dbo].[ArticuloSet]
...
-- Creating foreign key on [Actividad_Id] in table 'MagistralSet'
ALTER TABLE [dbo].[MagistralSet]
...
-- Creating foreign key on [Actividad_Id] in table 'ActividadParticipante'
ALTER TABLE [dbo].[ActividadParticipante]
...
-- Creating foreign key on [Actividad_Id] in table 'ActividadAsistente'
ALTER TABLE [dbo].[ActividadAsistente]
...
-- Creating foreign key on [Egreso_Id] in table 'MaterialSet'
ALTER TABLE [dbo].[MaterialSet]
